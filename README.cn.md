...
[![x-cmd/install — brows Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/brows.svg?lang=zh)](https://x-cmd.com/install/brows)
...
- **上游仓库**: <https://github.com/rubysolo/brows>
- **许可证**: MIT

## 发布

- **最新版本**: `v0.1.3` (2026-06-01)
- **最近提交**: 2026-06-01
- **Release 含资产**: 7 个

## 流行度

- **Star**: 86 · **Fork**: 3 · **开放 issue**: 1 · **贡献者**: 2

## 累计统计

- **发布数**: 4 · **已合并 PR**: 1 · **开放 PR**: 0 · **已关闭 issue**: 1 · **开放 issue**: 0 · **提交数**: 23
...
| last180d | 2026-03-29 | 1 | 0 | 0 | 0 | 0 | 1 |
| 360d | 2025-09-30 | 1 | 1 | 0 | 0 | 0 | 7 |
| last720d | 2024-10-05 | 1 | 1 | 0 | 1 | 0 | 8 |
...
brows 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `brows` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/brows.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260925.yml` · 2026-09-25T04:48:47Z._
